...
# Criação da caixa de texto
    ...
    ft.Column(
            ...
            controls=[                  
                ...
                ft.Image(src="imagens/triceps_corda.gif", width=200, height=200, border_radius=15),  # Adiciona o GIF no centro
               
               ft.Container(
                    content=ft.Column(
                        [
                            ft.Text("Exercício para fortalecimento e hipertrofia dos músculos tríceps, com enfoque o tríceps braquial.", 
